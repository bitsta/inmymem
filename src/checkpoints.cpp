...
namespace Checkpoints
{
    ...
    // harmonycoin: synchronized checkpoint (centrally broadcasted)
    ...
    // harmonycoin: get last synchronized checkpoint
    ...
    // harmonycoin: only descendant of current sync-checkpoint is allowed
    ...
    // harmonycoin: reset synchronized checkpoint to last hardened checkpoint
...
// harmonycoin: verify signature of sync-checkpoint message
...
// harmonycoin: process synchronized checkpoint
